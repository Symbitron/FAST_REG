...
BEGIN {
    ...
    require 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/test/fips-and-base.cnf';
    shift;
