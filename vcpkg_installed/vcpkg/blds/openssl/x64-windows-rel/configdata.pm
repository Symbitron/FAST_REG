...
our %config = (
    ...
    "openssldir" => "C:\\Users\\nikit\\source\\repos\\FAST_REG\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x64-windows",
    "options" => "enable-static-engine enable-capieng enable-shared --prefix=C:\\Users\\nikit\\source\\repos\\FAST_REG\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x64-windows --openssldir=C:\\Users\\nikit\\source\\repos\\FAST_REG\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x64-windows no-acvp-tests no-afalgeng no-apps no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-makedepend no-md2 no-msan no-rc5 no-sctp no-ssl3 no-ssl3-method no-tests no-trace no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "4",
...
unless (caller) {
    ...
    use lib 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/util/perl';
    use OpenSSL::fallback 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/Configurations';
        use gentemplate;
