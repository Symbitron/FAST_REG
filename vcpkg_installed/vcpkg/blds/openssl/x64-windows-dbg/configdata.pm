...
our %config = (
    ...
    "LDFLAGS" => [
        " -machine:x64 -nologo    -debug -INCREMENTAL "
    ],
    "LDLIBS" => [],
    "MT" => "mt",
    "MTFLAGS" => [
    ...
    "PERL" => "C:\\Users\\nikit\\AppData\\Local\\vcpkg\\downloads\\tools\\perl\\5.38.0.1\\perl\\bin\\perl.exe",
    "RC" => "rc",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30100",
    ...
    "openssldir" => "C:\\Users\\nikit\\source\\repos\\FAST_REG\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x64-windows\\debug",
    "options" => "enable-static-engine enable-capieng enable-shared --debug --prefix=C:\\Users\\nikit\\source\\repos\\FAST_REG\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x64-windows\\debug --openssldir=C:\\Users\\nikit\\source\\repos\\FAST_REG\\vcpkg_installed\\vcpkg\\pkgs\\openssl_x64-windows\\debug no-acvp-tests no-afalgeng no-apps no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-makedepend no-md2 no-msan no-rc5 no-sctp no-ssl3 no-ssl3-method no-tests no-trace no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "4",
    ...
    "perlargv" => [
        ...
        "LD=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.39.33519\\bin\\Hostx64\\x64\\link.exe",
        "LDFLAGS= -machine:x64 -nologo    -debug -INCREMENTAL "
    ],
    "perlenv" => {
        "AR" => undef,
        "ASFLAGS" => undef,
...
unless (caller) {
    ...
    use lib 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-dbg/util/perl';
    use OpenSSL::fallback 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-dbg/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'C:/Users/nikit/source/repos/FAST_REG/vcpkg_installed/vcpkg/blds/openssl/x64-windows-dbg/Configurations';
        use gentemplate;
